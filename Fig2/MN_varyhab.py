...
b = r*c
ini_re = 0.3
h_arr = np.arange(0.05, 0.99, 0.025)
...
plt.legend()
plt.ylim(0,140)
#plt.savefig('PT1_SCtoOthersVShab_beta'+str(bet)+'.png')
plt.show()
...
plt.legend()
plt.ylim(0,140)
#plt.savefig('PT1_SDtoOthersVShab_beta'+str(bet)+'.png')
plt.show()
...
plt.legend()
plt.ylim(0,140)
#plt.savefig('PT1_UCtoOthersVShab_beta'+str(bet)+'.png')
plt.show()
...
plt.legend()
plt.ylim(0,140)
#plt.savefig('PT1_UDtoOthersVShab_beta'+str(bet)+'.png')
plt.show()
# --------------------------------------------------------


# ---------------------------------------------------------
# Category Dynamics Plots
# ---------------------------------------------------------
...
#plt.savefig('PT1_satactVShab_beta'+str(bet)+'.png')
plt.show()
