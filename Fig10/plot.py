...
plt.ylabel('rewiring fraction'+r' ($\rho$)', fontsize=15)
...
plt.savefig('coopfracheat_rehab.jpg', dpi=300)
plt.show()
...
plt.xticks(fontsize=15)
plt.yticks(fontsize=15)
plt.title('average satisfaction before cooperation', fontsize=15)
#\n p11='+str(probs[0])
          #+' p10='+str(probs[1])+' p01='+str(probs[2])
          #+' p00='+str(probs[3]), fontsize=15)
plt.xlabel('habituation'+r' ($h$)', fontsize=15)
plt.ylabel('rewiring fraction'+r' ($\rho$)', fontsize=15)
plt.savefig('Csatheat_rehab.jpg', dpi=300)
plt.show()
...
plt.xlabel('habituation'+r' ($h$)', fontsize=15)
plt.ylabel('rewiring fraction'+r' ($\rho$)', fontsize=15)
plt.title('average satisfaction before defection', fontsize=15)
#\n p11='+str(probs[0])
          #+' p10='+str(probs[1])+' p01='+str(probs[2])
          #+' p00='+str(probs[3]), fontsize=15)
plt.savefig('Dsatheat_rehab.jpg', dpi=300)
plt.show()
...
#plt.title('C-C links \n p11='+str(probs[0])
          #+' p10='+str(probs[1])+' p01='+str(probs[2])
          #+' p00='+str(probs[3]), fontsize=15)
plt.savefig('CCheat_rehab.jpg', dpi=300)
plt.show()
...
#plt.title('C-D links \n p11='+str(probs[0])
          #+' p10='+str(probs[1])+' p01='+str(probs[2])
          #+' p00='+str(probs[3]), fontsize=15)
plt.savefig('CDheat_rehab.jpg', dpi=300)
plt.show()
...
#plt.title('D-D Links \n p11='+str(probs[0])
          #+' p10='+str(probs[1])+' p01='+str(probs[2])
          #+' p00='+str(probs[3]), fontsize=15)
plt.savefig('DDheat_rehab.jpg', dpi=300)
plt.show()
...
#plt.title('<deg(C)> \n p11='+str(probs[0])
          #+' p10='+str(probs[1])+' p01='+str(probs[2])
          #+' p00='+str(probs[3]), fontsize=15)
plt.savefig('Cdegheat_rehab.jpg', dpi=300)
plt.show()
...
#plt.title('<deg(D)> \n p11='+str(probs[0])
          #+' p10='+str(probs[1])+' p01='+str(probs[2])
          #+' p00='+str(probs[3]), fontsize=15)
plt.savefig('Ddegheat_rehab.jpg', dpi=300)
plt.show()
